...
class ImageMessageSocial extends StatefulWidget {
  const ImageMessageSocial({super.key, required this.message});
  final ChatMessage message;

  @override
  State<ImageMessageSocial> createState() => _ImageMessageSocialState();
}

class _ImageMessageSocialState extends State<ImageMessageSocial> {
          ...
          Padding(
              ...
              child: ClipOval(
                child: SizedBox(
                    ...
                    height: 40,
                    child: Image.memory(
                      base64Decode(widget.message.avatar),
                      fit: BoxFit.cover,
                    )),
              )),
        ],
